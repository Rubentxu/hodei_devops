...
func (rr *RoundRobin) SelectCandidateNodes(t model.Task, pools []*ports.ResourcePool) []*ports.ResourcePool {
...
func (rr *RoundRobin) Score(t model.Task, pools []*ports.ResourcePool) map[string]float64 {
