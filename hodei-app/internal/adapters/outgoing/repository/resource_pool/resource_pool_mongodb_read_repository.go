...
func NewResourcePoolMongoDBReadRepository(db *mongo.Database) ports.ReadOnlyRepository[*model.ResourcePoolDef] {
	converter := NewResourcePoolDocumentConverter()
...
func NewResourcePoolDocumentConverter() *ResourcePoolDocumentConverter {
