...
func (k *KubernetesResourcePool) monitorTask(ctx context.Context, taskExecution *model.TaskExecution, namespace string) {
...
func (k *KubernetesResourcePool) GetStats() (*model.Stats, error) {
	...
	stats := &model.Stats{
		MemStats:  &model.MemInfo{},
		DiskStats: &model.Disk{},
		CpuStats:  &model.CPUStat{},
		LoadStats: &model.LoadAvg{},
...
func (k *KubernetesResourcePool) aggregatePodMetrics(stats *model.Stats, podMetricsList *v1beta1.PodMetricsList) {
...
func (k *KubernetesResourcePool) aggregateNodeStats(stats *model.Stats, nodes *v1.NodeList) {
